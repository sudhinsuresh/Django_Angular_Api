...
SECRET_KEY = 'django-insecure-!19x!98yvn2!@o$)kh=58%1a11@xd)3u5ml$(u5y!esvwwozz('
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework.authentication.TokenAuthentication',  # Example authentication class
    ),
